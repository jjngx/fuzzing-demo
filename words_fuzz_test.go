...
func FuzzReverseString(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, s string) {
		firstReverse := words.ReverseString(s)
		secondReverse := words.ReverseString(firstReverse)
...
func FuzzReverseRunes(f *testing.F) {
	...
	// Fuzzing
	f.Fuzz(func(t *testing.T, s string) {
		firstReverse := words.ReverseRunes(s)
		secondReverse := words.ReverseRunes(firstReverse)
